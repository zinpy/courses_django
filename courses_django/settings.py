...
SECRET_KEY = '8m)o@$x-bg$t6zj+wg*n24#dy-2i)lff4t1($rx1nv+7q0=rlp'
...
INSTALLED_APPS = [
    ...
    'lesson_fifth.apps.LessonFifthConfig',
    'lesson_sixth.apps.LessonSixthConfig',
    'lesson_seventh.apps.LessonSeventhConfig',
]
